...
public class Match3 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        for (int i = 0; i < finishedUpdating.Count; i++)
        {
            ...
            if(WinLossManager.movedThisTurn && wasFlipped)
            {
                WinLossManager.movesRemaining--;
            }

            flipped.Remove(flip); //Remove the flip after update
            update.Remove(piece);
            WinLossManager.movedThisTurn = false;
        }
    }
